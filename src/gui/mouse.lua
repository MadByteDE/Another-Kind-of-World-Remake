...
function Mouse:init(x, y, t)
    ...
    self.type     = "mouse"
    self.dim      = {w=1, h=1}
    self:newSprite(self.type, Game.assets.spritesheet, Game.assets.getQuad("sprite", {7, 2}))
...
function Mouse:setPosition(x, y)
    love.mouse.setPosition(x*Game.screen.scale, y*Game.screen.scale)
end


function Mouse:getPosition()
    local mx, my = love.mouse.getPosition()
    return mx/Game.screen.scale, my/Game.screen.scale
end
