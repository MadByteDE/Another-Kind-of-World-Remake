...
return {
    glitter = {
        ...
        lifetime=1.5, range={x={-60, 60}, y={-50, -80}}, gravity=25,
    },

    blood = {
        images={Game.assets.particle.blood}, gravity=25,
        lifetime=.5, wrap=false, range={x={-25, 25}, y={-40, -80}},
    },

    explosion = {
        images={Game.assets.particle.smoke, Game.assets.particle.fire},
        lifetime=.8, wrap=false, range={x={-25, 25}, y={-40, -90}}, gravity=20,
    },

    dust = {
        images={Game.assets.particle.dust}, gravity=30,
