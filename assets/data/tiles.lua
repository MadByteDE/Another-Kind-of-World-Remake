...
return {
    ...
    {id=6,  name="drain",   type="tile", animdata={frames='1-8', row=1, duration=.05}, collide=true, solid=true},
    {id=7,  name="grass",   type="tile", animdata={frames='1-4', row=1, duration=.2}, randomFrame=true},
    {id=8,  name="water",   type="tile", animdata={frames='1-8', row=1, duration=.05}},
